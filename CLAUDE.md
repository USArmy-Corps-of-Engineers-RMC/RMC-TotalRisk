...
| `RMC.TotalRisk.RiskFunctions.Consequences` | `ConsequenceFunctionBase`, `TabularConsequence` (Phase 2+) |
...
| Results | SampledComponent / SampledFailureMode / ComponentRiskOutput / results containers | — | engine scenarios (Phases 5–6; moved to Phase 4 by the v0.9 re-scope) |
| Analyses | RiskAnalysis + RiskAnalysisOptions (reliability via RiskAnalysisMode) / CostBenefitAnalysis | — | full oracle families (Phases 5–6) + seed-bug regressions (Phase 4) |
