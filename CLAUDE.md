...
| `RMC.TotalRisk.RiskFunctions.Responses.Trees` | Common branching-response contracts: `TreeFragment`, `TreeLinkMode`, `TreeDeletePolicy`, `TreeNodeReference`, `ResponseBranchDescriptor`, `ResponseBranchSample`, `IBranchingResponseFunction` (Phase 10A) |
| `RMC.TotalRisk.RiskFunctions.Responses.EventTrees` | `EventTreeResponse`, `EventTree`, `EventNodeBase`, `InitiatingNode`, `ChanceNode`, `RemainderNode`, `EventTreeLinkNode`, `ProbabilitySource` (Phase 10A complete) |
