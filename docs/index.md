...
| [requirements/BIVARIATE_RISK_DESIGN.md](requirements/BIVARIATE_RISK_DESIGN.md) | Normative bivariate risk-analysis design (Phase 11, ratified 2026-08-03, not yet implemented): copula-linked bivariate hazard, two-way-table transform/consequence, the BivariateResponse port + joint mode, two-port graph, conditional-bin engine integration, verification program |
...
| [technical-reference/](technical-reference/README.md) | Per-family math documentation: input-function families, system components and the risk-element graph, the risk engine's integration and loss-exceedance construction, composites, cascades, event trees, fault trees, sensitivity, hashing/seeding, and the results catalog |
