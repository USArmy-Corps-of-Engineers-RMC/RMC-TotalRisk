...
**Status**: 2026-07-24 — **v0.17** (Phase 6.6 landing; supersedes conflicting text below wherever it appears). The measures/diagnostics/sensitivity closures:
