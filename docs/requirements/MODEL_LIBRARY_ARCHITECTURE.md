...
**Status**: 2026-07-22 — **v0.14** (Phase 4 engine-core landing; supersedes conflicting text below wherever it appears). The session ratifications and implementation errata from landing the 1D engine core:
