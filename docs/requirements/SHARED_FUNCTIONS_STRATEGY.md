...
> **Status:** v1.0, ratified 2026-07-19. Moved to its authoritative home (`docs/requirements/` in the RMC-TotalRisk repo) on 2026-07-20; the copy at the `RMC-TotalRisk-Dev` root is frozen with a pointer here, and relative links to Dev-repo files (ROADMAP/MEMORY/CLAUDE) refer to that repo. Companion to [MODEL_LIBRARY_ARCHITECTURE.md](MODEL_LIBRARY_ARCHITECTURE.md) v0.7, which carries the TotalRisk-side amendments.
>
