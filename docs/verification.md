...
| 10B | `FaultTree` — exhaustive Boolean enumeration, closed-form gates/repeated-event identities, coherent cut-set inspection, independent Boolean MC, graph-connected equivalence, LHS, reproducibility, and ROBDD resource/performance gates. |
