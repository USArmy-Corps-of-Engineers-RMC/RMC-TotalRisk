...
| [Event-tree response — foundation + independent links](event-tree.md) | `EventTreeVerification` | Analytic path products/normalization, aligned-table LHS parity, explicit-clone link parity, two-mode resolver round trips, and linked-occurrence reproducibility | 🟡 Two verified slices (5/5, 2026-07-28); Phase 10A verification remains open |
