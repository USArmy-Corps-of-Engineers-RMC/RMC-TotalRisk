...
**Test class:** `ScalarUncertaintyVerification` · **Landed:** 2026-07-24 (Phase 6.6, stage 5)

The curve percentile bands landed with the Phase 4 engine; the scalar risk-measure catalog
carried no intervals until Phase 6.6's `EnsembleSummary`: four `SystemRiskResults` trees —
...
N = 2,000 ensembles plus the deterministic companion); fast suite 462/462; gate
`SingleComponentUncertaintyVerification` 4/4 passed unchanged (3 m 02 s).
